...
const urls = {
  ...
  Scene10: encodeURI(FOLDER_PATH + "Scene 10 Alonso HOSHI.mp4"),
  ...
  Scene14Line2: encodeURI(FOLDER_PATH + "Scene 14 Line 2 HOSHI.mp4"),
  Scene15Line2: encodeURI(FOLDER_PATH + "Scene 15 Line 2 Hernandez.mp4"),
  Scene16Line1: encodeURI(FOLDER_PATH + "Scene 16 Line 1 HOSHI.mp4"),
  ...
  Scene19Line2: encodeURI(FOLDER_PATH + "Scene 19 Line 2 HOSHI.mp4"),
  Scene20Line1: encodeURI(FOLDER_PATH + "Scene 20 Line 1 Alonso.mp4"),
  Scene20Line2: encodeURI(FOLDER_PATH + "Scene 20 Line 2 HOSHI.mp4"),
  Scene20Error1: encodeURI(FOLDER_PATH + "Scene 20 Error Msg 1.mp4"),
  Scene20Error2: encodeURI(FOLDER_PATH + "Scene 20 Error Msg 2.mp4"),
  Scene20Error3: encodeURI(FOLDER_PATH + "Scene 20 Error Msg 3.mp4"),
  Scene20Error4: encodeURI(FOLDER_PATH + "Scene 20 Error Msg 4.mp4"),
  Scene21Line1: encodeURI(FOLDER_PATH + "Scene 21 - Stephan and Kim.mp4"),
  Scene21Line2: encodeURI(FOLDER_PATH + "Scene 21 Stephan - HOSHI.mp4"),
  Scene22Line1: encodeURI(FOLDER_PATH + "Scene 22 Line 1 Siggson.mp4"),
  Scene22Line2: encodeURI(FOLDER_PATH + "Scene 22 Line 2 HOSHI.mp4"),
  ...
  Scene24Line1: encodeURI(FOLDER_PATH + "Scene+24+Line+1+Vasquez.mp4"), // firefox error 416 workaround
  ...
  Scene25Error1: encodeURI(FOLDER_PATH + "Scene 25 Error Msg 1.mp4"),
  Scene25Error2: encodeURI(FOLDER_PATH + "Scene 25 Error Msg 2.mp4"),
  Scene25Error3: encodeURI(FOLDER_PATH + "Scene 25 Error Msg 3.mp4"),
  Scene26Line1: encodeURI(FOLDER_PATH + "Scene 26 Line 1 Hogan.mp4"),
  Scene26Line2: encodeURI(FOLDER_PATH + "Scene 26 Line 2 Hogan.mp4"),
  ...
  Scene28ErrorS: encodeURI(FOLDER_PATH + "Scene 28 Error Msg 4.mp4"),
